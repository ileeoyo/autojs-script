...
// 房间-退出房间
const exitRoomSelector = () => { visibleSelector().untilFindOne(); return visibleSelector().id(douYinPackageName + ":id/root").className("Button").desc("关闭").clickable() };
// 房间-退出直播结束的房间
const exitEndedRoomSelector = () => { visibleSelector().untilFindOne(); return visibleSelector().className("android.view.View").desc("关闭").clickable() };
// 房间-不满足参与条件
